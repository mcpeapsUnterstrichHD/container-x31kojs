...
> Be patient! In ~3 mins your app is live, at your [app url](https://container-x31kojs.containers.anotherwebservice.com/). It even has a free SSL/TLS certificate 🔒 you're welcome!
...
Your app will be automatically re-deployed with the latest code at: https://container-x31kojs.containers.anotherwebservice.com/
...
```
git clone git@github.com:mcpeapsUnterstrichHD/container-x31kojs.git
cd container-x31kojs
```
...
```
docker attach container-x31kojs
```
